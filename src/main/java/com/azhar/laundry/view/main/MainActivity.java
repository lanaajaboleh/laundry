...
import com.azhar.laundry.view.AboutUs.AboutUsActivity;
...
import com.azhar.laundry.view.LayananActivity;
...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    ModelMenu modelMenu;
    android.widget.Button ButtonAbUs;
    android.widget.Button ButtonHome;
    android.widget.Button ButtonLayanan;
    ...
    private void setInitLayout() {
        ...
        ButtonAbUs = findViewById(R.id.buttonAbUs);
        ButtonHome = findViewById(R.id.buttonHome);
        ButtonLayanan = findViewById(R.id.buttonLayanan);
        ...
        ButtonAbUs.setOnClickListener((v-> {
            Intent intent = new Intent(MainActivity.this, AboutUsActivity.class);
            startActivity(intent);
        }));

        ButtonLayanan.setOnClickListener((v -> {
